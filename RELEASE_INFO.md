# Melo Music v5.1.6 - Beta Release

- Migrated default Listen Together server to Melo Music Server on Hugging Face (wss://iad1tya-melomusic.hf.space/ws). To modify or verify the URL, navigate to Listen Together > Settings > Server URL.
- Configured single Universal GMS release APK outputs (Melo-5.1.6-Universal.apk) and streamlined update checker logic.
