# Contributing to Melo Music

Thank you for your interest in contributing to Melo Music! This document provides comprehensive guidelines and information for contributors.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Melo-Music.git
   cd Melo-Music
   ```
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/iad1tya/Melo-Music.git
   ```
...
2. Add Android apps with package names:
   - `iad1tya.melo.music` (release)
   - `iad1tya.melo.music.debug` (debug)
...
When contributing to Melo Music, it's crucial to handle sensitive information properly:
...
```
app/src/main/java/com/maxrave/melo/
...
- **Packages**: lowercase (`com.maxrave.melo.ui`)
...
./gradlew test --tests "iad1tya.melo.MusicPlayerTest"
...
1. Check the [GitHub Discussions](https://github.com/iad1tya/Melo-Music/discussions)
...
Thank you for contributing to Melo Music!
