...
object ListenTogetherServers {
    private const val SERVER_JSON_URL = "https://raw.githubusercontent.com/MeloMusicApp/Melo-Music/refs/heads/main/app/server.json"

    private val _servers = MutableStateFlow(
        listOf(
            ListenTogetherServer(
                name = "Melo Music Server",
                url = "wss://iad1tya-melomusic.hf.space/ws",
                location = "Global",
                operator = "VIVIDH"
            )
        )
