...
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import iad1tya.melo.music.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "iad1tya.melo.music.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "iad1tya.melo.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "iad1tya.melo.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "iad1tya.melo.music.widget.recognizer.RESET"
    }
}
