...
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import com.hyperlabs.melo.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "com.hyperlabs.melo.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.hyperlabs.melo.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.hyperlabs.melo.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.hyperlabs.melo.widget.recognizer.RESET"
    }
}
