...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/MeloMusicApp/workflows/nightly.yml/main/melomusic-gms-nightly.zip"
        } else {
            "https://github.com/MeloMusicApp/Melo-Music/releases/download/$versionName/melomusic.apk"
        }
