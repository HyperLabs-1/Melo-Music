<div align="center">
  <img src="assets/Melo-new.png" alt="Melo Music Logo" width="140"/>
  ...
  [![GitHub Release](https://img.shields.io/github/v/release/iad1tya/Melo-Music?style=for-the-badge&color=6f42c1)](https://github.com/iad1tya/Melo-Music/releases)
  [![GitHub Stars](https://img.shields.io/github/stars/iad1tya/Melo-Music?style=for-the-badge&color=e3b341)](https://github.com/iad1tya/Melo-Music/stargazers)
  [![License](https://img.shields.io/github/license/iad1tya/Melo-Music?style=for-the-badge&color=28a745)](LICENSE)
  [![Telegram](https://img.shields.io/badge/Telegram-Join-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/MeloMusicApp)
  ...
  <a href="https://trendshift.io/repositories/20485" target="_blank">
    <img src="https://trendshift.io/api/badge/repositories/20485" alt="MeloMusicApp%2FMelo-Music | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/>
  </a>

  <br>

  <a href="https://melomusic.fun/download">
    <img src="assets/download.png" alt="Download" width="180"/>
  </a>
  &nbsp;
  <a href="https://melomusic.fun/obtainium">
...
Melo Music delivers a seamless, premium listening experience by leveraging YouTube Music's vast library — without the ads. It adds powerful extras including offline downloads, real-time synchronized lyrics, and environment-aware music recognition.
...
- [Features](#features)
  ...
  - [Discovery & Melo Find](#discovery--melo-find)
  - [Lyrics](#lyrics)
...
<div align="center">
  <table style="margin: 0 auto; border-collapse: collapse;">
    ...
    <tr>
      ...
      <td align="center" style="padding: 10px; border: none;">
        <strong>Melo Find (Recognition)</strong><br><br>
        <img src="Screenshots/sc_6.png" alt="Melo Find" width="200" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"/>
      </td>
    </tr>
  </table>
</div>
...
### Discovery & Melo Find
- **Melo Find** — Identify songs playing around you using advanced audio recognition.
...
Download the latest pre-compiled APK from the [Releases Page](https://github.com/iad1tya/Melo-Music/releases/latest).

### Building from Source

1. **Clone the Repository**
   ```bash
   git clone https://github.com/iad1tya/Melo-Music.git
   cd Melo-Music
   ```
...
2. **Configure Android SDK**
   ...
   ```bash
   melo "sdk.dir=/path/to/your/android/sdk" > local.properties
   ```
...
4. **Build the Application**
   Melo Music has two build variants: **FOSS** (without Google Play Services / Cast) and **GMS** (with Cast support).
...
<div align="center">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;
  <a href="https://t.me/MeloMusicApp">
...
If Melo Music has been useful to you, consider supporting its development.
...
Melo Music stands on the shoulders of several excellent open-source projects. Sincere thanks to:
...
| [Music Recognizer](https://github.com/aleksey-saenko/MusicRecognizer) | Audio recognition (Melo Find) |

---

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=MeloMusicApp/Melo-Music&type=timeline&legend=top-left)](https://www.star-history.com/#MeloMusicApp/Melo-Music&type=timeline&legend=top-left)
