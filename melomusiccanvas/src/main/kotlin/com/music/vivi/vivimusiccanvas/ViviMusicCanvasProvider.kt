...
@Serializable
data class melomusicCanvasManifest(
    val items: List<melomusicCanvasItem> = emptyList()
)

@Serializable
data class melomusicCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)

object melomusicCanvasProvider {
    private const val BASE_URL = "https://canvas.melomusic.fun/canvas.json"
    ...
    private data class CacheEntry(
        val value: melomusicCanvasManifest?,
    ...
    private suspend fun fetchManifest(): melomusicCanvasManifest? {
        ...
        return try {
            val manifest: melomusicCanvasManifest = client.get(BASE_URL).body()
